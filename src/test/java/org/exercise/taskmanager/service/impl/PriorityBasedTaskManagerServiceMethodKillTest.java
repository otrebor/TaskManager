...
class PriorityBasedTaskManagerServiceMethodKillTest extends PriorityBasedTaskManagerServiceTestBase {
    ...
    public void testKill() throws AcceptProcessException, KillProcessException, ProcessNotFoundException {
        ...
        Assertions.assertThat(list)
                .isNotNull()
                .hasSize(4)
                .containsExactly(process4, process1, process5, process3);
    }
    ...
    public void testKillGroup() throws AcceptProcessException, KillProcessException, ProcessNotFoundException {
        ...
        Assertions.assertThat(list)
                .isNotNull()
                .hasSize(2)
                .containsExactly(process4, process3);
    }
